...
//    value
//      .map {
//        case "Yes"  => super.cleanup(value, userAnswers)
//        case "No" =>
//          userAnswers
...
//      .getOrElse(super.cleanup(value, userAnswers))
  ...
  override protected def navigateInNormalMode(answers: UserAnswers): Call =
    answers.get(ThresholdIncomePage(period)) match {
      case Some(_)  => AdjustedIncomeController.onPageLoad(NormalMode, period)
      case _ => TotalIncomeController.onPageLoad(NormalMode, period)
      case None        => controllers.routes.JourneyRecoveryController.onPageLoad(None)
    }

  override protected def navigateInCheckMode(answers: UserAnswers): Call =
    answers.get(ThresholdIncomePage(period)) match {
      case Some(_)  => AdjustedIncomeController.onPageLoad(CheckMode, period)
      case _ => CheckYourAAPeriodAnswersController.onPageLoad(period)
      case None        => controllers.routes.JourneyRecoveryController.onPageLoad(None)
    }
}

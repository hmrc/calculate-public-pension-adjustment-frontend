  ...
  override def cleanup(value: Option[Boolean], userAnswers: UserAnswers): Try[UserAnswers] =
    value
      .map {
        ...
        case false =>
          val answersWithNoPreAA = PreAASection.removeAllUserAnswers(userAnswers)
          val answersWithNoAA    = AASection.removeAllAAPeriodAnswers(answersWithNoPreAA)
          val answersWithNoLTA   = LTASection.removeAllUserAnswers(answersWithNoAA)
          answersWithNoLTA

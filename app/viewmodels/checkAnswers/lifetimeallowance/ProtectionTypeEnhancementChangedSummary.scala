...
object ProtectionTypeEnhancementChangedSummary  {
  ...
  def row(answers: UserAnswers)(implicit messages: Messages): Option[SummaryListRow] =
    answers.get(ProtectionTypeEnhancementChangedPage).map {
      answer =>
        ...
        SummaryListRowViewModel(
          ...
          actions = Seq(
            ActionItemViewModel("site.change", routes.ProtectionTypeEnhancementChangedController.onPageLoad(CheckMode).url)

...
object DefinedContribution2016PostFlexiAmountSummary {

  def row(answers: UserAnswers)(implicit messages: Messages): Option[SummaryListRow] =
    answers.get(DefinedContribution2016PostFlexiAmountPage).map { answer =>
      ...
      SummaryListRowViewModel(
        key = messages("definedContribution2016PostFlexiAmount.checkYourAnswersLabel", startEndDate),

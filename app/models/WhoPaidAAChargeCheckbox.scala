...
sealed trait WhoPaidAAChargeCheckbox
...
object WhoPaidAAChargeCheckbox extends Enumerable.Implicits {
    ...
    values.zipWithIndex.map {
      case (value, index) =>
        CheckboxItemViewModel(
          content = Text(messages(s"whoPaidAAChargeCheckbox.${value.toString}")),
          fieldId = "value",
          index   = index,
  ...
  implicit val enumerable: Enumerable[WhoPaidAAChargeCheckbox] =

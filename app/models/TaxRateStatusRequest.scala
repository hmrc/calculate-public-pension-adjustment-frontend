...
case class TaxRateStatusRequest(
  period: Period,
  income: BigInt,
  scottishTaxYears: List[Period]
)

object TaxRateStatusRequest {

  implicit lazy val reads: Reads[TaxRateStatusRequest] = {
    ...
    )(TaxRateStatusRequest.apply _)
  }

  implicit lazy val writes: Writes[TaxRateStatusRequest] = {

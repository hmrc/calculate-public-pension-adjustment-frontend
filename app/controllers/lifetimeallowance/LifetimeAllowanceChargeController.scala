...
class LifetimeAllowanceChargeController @Inject() (
  ...
  formProvider: LifetimeAllowanceChargeFormProvider,
  val controllerComponents: MessagesControllerComponents,
  view: LifetimeAllowanceChargeView
  ...
  def onPageLoad(mode: Mode): Action[AnyContent] = (identify andThen getData andThen requireData) { implicit request =>
    val preparedForm = request.userAnswers.get(LifetimeAllowanceChargePage) match {
      case None        => form

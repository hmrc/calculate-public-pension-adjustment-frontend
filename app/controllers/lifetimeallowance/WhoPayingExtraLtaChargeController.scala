...
class WhoPayingExtraLtaChargeController @Inject() (
  ...
  formProvider: WhoPayingExtraLtaChargeFormProvider,
  val controllerComponents: MessagesControllerComponents,
  view: WhoPayingExtraLtaChargeView
  ...
  def onPageLoad(mode: Mode): Action[AnyContent] = (identify andThen getData andThen requireData) { implicit request =>
    val preparedForm = request.userAnswers.get(WhoPayingExtraLtaChargePage) match {
      case None        => form

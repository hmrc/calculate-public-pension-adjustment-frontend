...
class DoYouHaveCodeAdjustmentController @Inject() (
  override val messagesApi: MessagesApi,
  userDataService: UserDataService,
  identify: IdentifierAction,
  getData: DataRetrievalAction,
  requireData: DataRequiredAction,
  formProvider: DoYouHaveCodeAdjustmentFormProvider,
  val controllerComponents: MessagesControllerComponents,
  view: DoYouHaveCodeAdjustmentView
    ...
    implicit request =>
      ...
      form
        ...
        .fold(
          ...
          value =>
            for {
              updatedAnswers <- Future.fromTry(request.userAnswers.set(DoYouHaveCodeAdjustmentPage(period), value))
              redirectUrl     = DoYouHaveCodeAdjustmentPage(period).navigate(mode, updatedAnswers).url

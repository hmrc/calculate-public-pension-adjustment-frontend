...
class BlindPersonsAllowanceAmountController @Inject() (
  override val messagesApi: MessagesApi,
  userDataService: UserDataService,
  identify: IdentifierAction,
  getData: DataRetrievalAction,
  requireData: DataRequiredAction,
  formProvider: BlindPersonsAllowanceAmountFormProvider,
  val controllerComponents: MessagesControllerComponents,
  view: BlindPersonsAllowanceAmountView
    ...
    implicit request =>
      ...
      form
        ...
        .fold(
          ...
          value =>
            for {
              updatedAnswers <- Future.fromTry(request.userAnswers.set(BlindPersonsAllowanceAmountPage(period), value))
              redirectUrl     = BlindPersonsAllowanceAmountPage(period).navigate(mode, updatedAnswers).url

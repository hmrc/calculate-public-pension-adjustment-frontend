...
import forms.annualallowance.taxyear.HowMuchContributionPensionSchemeFormProvider
...
import views.html.annualallowance.taxyear.HowMuchContributionPensionSchemeView
...
class HowMuchContributionPensionSchemeController @Inject() (
  override val messagesApi: MessagesApi,
  userDataService: UserDataService,
  identify: IdentifierAction,
  getData: DataRetrievalAction,
  requireData: DataRequiredAction,
  formProvider: HowMuchContributionPensionSchemeFormProvider,
  val controllerComponents: MessagesControllerComponents,
  view: HowMuchContributionPensionSchemeView
  ...
  def onPageLoad(mode: Mode, period: Period): Action[AnyContent] = (identify andThen getData andThen requireData) {
    implicit request =>
      val preparedForm = request.userAnswers.get(HowMuchContributionPensionSchemePage(period)) match {
        case None        => form
      ...
      form
        ...
        .fold(
          ...
          value =>
            for {
              updatedAnswers <-
                Future.fromTry(request.userAnswers.set(HowMuchContributionPensionSchemePage(period), value))
              redirectUrl     = HowMuchContributionPensionSchemePage(period).navigate(mode, updatedAnswers).url

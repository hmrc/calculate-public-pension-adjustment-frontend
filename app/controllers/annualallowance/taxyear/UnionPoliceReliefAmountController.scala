...
class UnionPoliceReliefAmountController @Inject() (
  ...
  formProvider: UnionPoliceReliefAmountFormProvider,
  val controllerComponents: MessagesControllerComponents,
  view: UnionPoliceReliefAmountView
    ...
    implicit request =>
      ...
      form
        ...
        .fold(
          ...
          value =>
            for {
              updatedAnswers <- Future.fromTry(request.userAnswers.set(UnionPoliceReliefAmountPage(period), value))
              redirectUrl     = UnionPoliceReliefAmountPage(period).navigate(mode, updatedAnswers).url

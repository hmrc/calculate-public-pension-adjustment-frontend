...
pensionSchemeInputAmounts.revisedPIA.hint1 = cy: This is in the communication from your pension scheme.
pensionSchemeInputAmounts.revisedPIA.hint2 = cy: Amounts must be rounded down to the nearest pound, for example 2300.
...
pensionSchemeInputAmounts.error.revisedPIA.wholeNumber = cy: You have not entered a whole number for your pension input amount. You cannot use decimals.
...
whoPaidAACharge.title = cy: Who paid the annual allowance charge?
whoPaidAACharge.heading = cy: Who paid the annual allowance charge for? {0} {1}
whoPaidAACharge.you = cy: You
whoPaidAACharge.scheme = cy: Pension Scheme
whoPaidAACharge.both = cy: Both
whoPaidAACharge.checkYourAnswersLabel = cy: Who paid the annual allowance charge?
whoPaidAACharge.error.required = cy: Enter who paid the annual allowance charge
whoPaidAACharge.change.hidden = cy: Who paid the annual allowance charge?

howMuchAAChargeSchemePaid.title = cy: How much of the charge did your scheme pay?
howMuchAAChargeSchemePaid.heading = cy: How much of the charge did your scheme pay? {0} {1}
howMuchAAChargeSchemePaid.checkYourAnswersLabel = cy: How much of the charge did your scheme pay?
howMuchAAChargeSchemePaid.error.nonNumeric = cy: Enter your how much your scheme paid using numbers
howMuchAAChargeSchemePaid.error.required = cy: Enter your how much your scheme paid
howMuchAAChargeSchemePaid.error.wholeNumber = cy: Enter your how much your scheme paid using whole numbers
howMuchAAChargeSchemePaid.error.outOfRange = cy: How much your scheme paid must be between {0} and {1}
...
howMuchAAChargeYouPaid.heading = cy: How much of the charge did you pay? {0} {1}
howMuchAAChargeYouPaid.checkYourAnswersLabel = cy: How much of the charge did you pay?
howMuchAAChargeYouPaid.error.nonNumeric = cy: Enter your how much you paid using numbers
...
ltaPensionSchemeDetails.title = cy: What is the name and tax reference of the scheme that paid the charge?
ltaPensionSchemeDetails.heading = cy: What is the name and tax reference of the scheme that paid the charge?
...
ltaPensionSchemeDetails.hint2 = cy: You can find the PSTR can on your pension scheme’s annual statement. For example, 00348916RT.

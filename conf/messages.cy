...
payACharge.heading = cy: Did you pay a charge? {0} {1}
...
pensionSchemeDetails.title = cy: What is the name and tax reference of the scheme that paid the charge?
pensionSchemeDetails.heading = cy: What is the name and tax reference of the scheme that paid the charge? {0} {1}
...
pensionSchemeDetails.checkYourAnswersLabel = cy: What is the name and tax reference of the scheme that paid the charge?
pensionSchemeDetails.error.schemeName.required = cy: Enter schemeName
pensionSchemeDetails.error.schemeTaxRef.required = cy: Enter schemeTaxRef
pensionSchemeDetails.error.schemeName.length = cy: schemeName must be schemeTaxRef characters or less
pensionSchemeDetails.error.schemeTaxRef.length = cy: schemeTaxRef must be 100 characters or less
pensionSchemeDetails.schemeName.change.hidden = cy: What is the name and tax reference of the scheme that paid the charge?
...
pensionSchemeInputAmounts.checkYourAnswersLabel = cy: Pension scheme that has paid
pensionSchemeInputAmounts.error.originalPIA.required = cy: Enter originalPIA
pensionSchemeInputAmounts.error.revisedPIA.required = cy: Enter revisedPIA
pensionSchemeInputAmounts.error.originalPIA.length = cy: originalPIA must be 100 characters or less
pensionSchemeInputAmounts.error.revisedPIA.length = cy: revisedPIA must be 100 characters or less
pensionSchemeInputAmounts.originalPIA.change.hidden = cy: originalPIA
pensionSchemeInputAmounts.revisedPIA.change.hidden = cy: revisedPIA

whichScheme.title = cy: Select which scheme paid the charge or add new.
whichScheme.heading = cy: Select which scheme paid the charge or add new. {0} {1}
whichScheme.New = cy: New
whichScheme.checkYourAnswersLabel = cy: Select which scheme paid the charge or add new.
whichScheme.error.required = cy: Select which scheme paid the charge or add new.
whichScheme.change.hidden = cy: Select which scheme paid the charge or add new.

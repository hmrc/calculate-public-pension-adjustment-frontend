...
schemeNameAndTaxRef.title = cy: What is the name of the pension scheme that paid your lifetime allowance charge?
schemeNameAndTaxRef.heading = cy: What is the name of the pension scheme that paid your lifetime allowance charge?
...
schemeNameAndTaxRef.taxRef.hint = cy: You can find the PSTR can on your pension scheme’s annual statement. For example, 00348916RT.
schemeNameAndTaxRef.checkYourAnswersLabel = cy: What is the name of the pension scheme that paid your lifetime allowance charge?
schemeNameAndTaxRef.name.error.required = cy: Enter the name of the pension scheme that paid the tax charge
schemeNameAndTaxRef.taxRef.error.required = cy: Enter the pension scheme tax reference of the scheme that paid the tax charge
schemeNameAndTaxRef.name.error.length = cy: Name of the pension scheme must be 100 characters or less
schemeNameAndTaxRef.taxRef.error.length = cy: Pension scheme tax reference must be 100 characters or less
schemeNameAndTaxRef.taxRef.invalid = cy: Pension scheme tax reference must be of the suggested format
schemeNameAndTaxRef.change.hidden = cy: What is the name of the pension scheme that paid your lifetime allowance charge?

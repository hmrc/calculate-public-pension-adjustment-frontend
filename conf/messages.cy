...
whatYouWillNeedAA.title = cy: {0} remedy period
...
addAnotherScheme.title = cy: addAnotherScheme {0}
addAnotherScheme.heading = cy: addAnotherScheme {0}
addAnotherScheme.checkYourAnswersLabel = cy: addAnotherScheme {0}
addAnotherScheme.error.required = cy: Select yes if addAnotherScheme {0}
addAnotherScheme.change.hidden = cy: AddAnotherScheme {0}

haveChangedScheme.title = cy: Have you changed your pension scheme?
haveChangedScheme.heading = cy: Have you changed your pension scheme?
haveChangedScheme.error.required = cy: Select yes if you have changed your pension scheme since the last tax year
haveChangedScheme.change.hidden = cy: Have you changed your pension scheme?

payACharge.title = cy: payACharge {0} {1}
payACharge.heading = cy: payACharge {0} {1}
payACharge.checkYourAnswersLabel = cy: payACharge
payACharge.error.required = cy: Select yes if payACharge {0} {1}
payACharge.change.hidden = cy: payACharge {0} {1}

pensionSchemeDetails.title = cy: What is the name and tax reference of the pension scheme? - Period : {0} SchemeIndex : {1}
pensionSchemeDetails.heading = cy: What is the name and tax reference of the pension scheme? - Period : {0} SchemeIndex : {1}
pensionSchemeDetails.schemeName = cy: What is the name and tax reference of the pension scheme? - Period : {0} SchemeIndex : {1}
pensionSchemeDetails.schemeTaxRef = cy: schemeTaxRef
...
pensionSchemeDetails.error.schemeName.length = cy: schemeName must be schemeTaxRef characters or less {0} {1}
pensionSchemeDetails.error.schemeTaxRef.length = cy: schemeTaxRef must be 100 characters or less {0} {1}
pensionSchemeDetails.schemeName.change.hidden = cy: schemeName {0} {1}
pensionSchemeDetails.schemeTaxRef.change.hidden = cy: schemeTaxRef {0} {1}

pensionSchemeInputAmounts.title = cy: Pension scheme [PSTR for SchemeIndex : {1}] input amounts - Period : {0}
pensionSchemeInputAmounts.heading = cy: Pension scheme [PSTR for SchemeIndex : {1}] input amounts - Period : {0}
pensionSchemeInputAmounts.originalPIA = cy: originalPIA
pensionSchemeInputAmounts.revisedPIA = cy: revisedPIA
pensionSchemeInputAmounts.checkYourAnswersLabel = cy: pensionSchemeInputAmounts
...
pensionSchemeInputAmounts.error.originalPIA.length = cy: originalPIA must be 100 characters or less {0} {1}
pensionSchemeInputAmounts.error.revisedPIA.length = cy: revisedPIA must be 100 characters or less {0} {1}
...
whichScheme.title = cy: whichScheme
whichScheme.heading = cy: whichScheme
whichScheme.new = cy: new
whichScheme.existing = cy: existing
whichScheme.checkYourAnswersLabel = cy: whichScheme
whichScheme.error.required = cy: Select whichScheme
whichScheme.change.hidden = cy: WhichScheme

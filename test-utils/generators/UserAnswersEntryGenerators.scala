...
trait UserAnswersEntryGenerators extends PageGenerators with ModelGenerators {
  ...
  implicit lazy val arbitraryMemberOfPublicPensionSchemeUserAnswersEntry
    : Arbitrary[(MemberOfPublicPensionSchemePage.type, JsValue)] =
    Arbitrary {
      for {
        page  <- arbitrary[MemberOfPublicPensionSchemePage.type]

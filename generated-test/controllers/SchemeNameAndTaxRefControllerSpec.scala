...
import views.html.SchemeNameAndTaxRefView
...
class SchemeNameAndTaxRefControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val schemeNameAndTaxRefRoute = routes.SchemeNameAndTaxRefController.onPageLoad(NormalMode).url
  ...
  "SchemeNameAndTaxRef Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = UserAnswers(userAnswersId).set(SchemeNameAndTaxRefPage, "answer").success.value

...
class MarriageAllowancePageSpec extends PageBehaviours {

  "MarriageAllowancePage" - {

    beRetrievable[Boolean](MarriageAllowancePage(Period._2018))

    beSettable[Boolean](MarriageAllowancePage(Period._2018))

    beRemovable[Boolean](MarriageAllowancePage(Period._2018))

    "Normal Mode" - {

      "must redirect to MarriageAllowanceAmount page when true" in {

        val userAnswers = emptyUserAnswers
          .set(MarriageAllowancePage(Period._2018), true)
          .success
          .value
      ...
      "must redirect to BlindAllowance page when false" in {
        ...
        val userAnswers = emptyUserAnswers
          .set(MarriageAllowancePage(Period._2018), false)
          .success
          .value

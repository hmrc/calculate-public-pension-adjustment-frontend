...
class AmountClaimedOnOverseasPensionFormProviderSpec extends IntFieldBehaviours {

  val form = new AmountClaimedOnOverseasPensionFormProvider()()
...
//    )
    ...
    behave like mandatoryField(
      form,
      fieldName,
      requiredError = FormError(fieldName, "amountClaimedOnOverseasPension.error.required")
    )
  }
}

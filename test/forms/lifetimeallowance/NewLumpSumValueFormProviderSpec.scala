...
class NewLumpSumValueFormProviderSpec extends IntFieldBehaviours {

  val form = new NewLumpSumValueFormProvider()()
  ...
  ".value" - {
    ...
    behave like mandatoryField(
      form,
      fieldName,
      requiredError = FormError(fieldName, "newLumpSumValue.error.required")
    )
  }
}

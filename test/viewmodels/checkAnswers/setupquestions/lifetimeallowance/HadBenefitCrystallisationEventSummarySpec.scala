...
class HadBenefitCrystallisationEventSummarySpec extends AnyFreeSpec with Matchers {
  ...
  "row" - {
    "when Yes is selected, return the summary row" in {
      val userAnswers = UserAnswers("id")
        ...
        .get
      HadBenefitCrystallisationEventSummary.row(userAnswers) shouldBe Some(
    ...
    "when answer unavailable, return empty" in {
      val userAnswers = UserAnswers("id")
      HadBenefitCrystallisationEventSummary.row(userAnswers) shouldBe None
    }
  }

...
import viewmodels.checkAnswers.setupQuestions.ResubmittingAdjustmentSummary
import viewmodels.govuk.summarylist._
import viewmodels.implicits._

class ResubmittingAdjustmentSummarySpec extends AnyFreeSpec with Matchers {
        ...
        SummaryListRowViewModel(
          ...
          actions = Seq(
            ActionItemViewModel("site.change", routes.ResubmittingAdjustmentController.onPageLoad(CheckMode).url)
              .withVisuallyHiddenText("resubmittingAdjustment.change.hidden")
          )
        )
      )
    }

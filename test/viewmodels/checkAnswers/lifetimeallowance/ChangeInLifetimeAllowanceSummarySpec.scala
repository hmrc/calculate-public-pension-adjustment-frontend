...
import pages.lifetimeallowance.{ChangeInLifetimeAllowancePage, HadBenefitCrystallisationEventPage}
      ...
      ChangeInLifetimeAllowanceSummary.row(userAnswers) shouldBe Some(
        SummaryListRowViewModel(
          ...
          actions = Seq(
            ActionItemViewModel(
              "site.change",
              routes.ChangeInLifetimeAllowanceController.onPageLoad(CheckMode).url
            )

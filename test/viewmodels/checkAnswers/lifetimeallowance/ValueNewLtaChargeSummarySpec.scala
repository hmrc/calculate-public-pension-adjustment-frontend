...
import pages.lifetimeallowance.{LifetimeAllowanceChargeAmountPage, ValueNewLtaChargePage}
import play.api.i18n.Messages
import play.api.test.Helpers
import viewmodels.govuk.summarylist._
import viewmodels.implicits._

class ValueNewLtaChargeSummarySpec extends AnyFreeSpec with Matchers {
  ...
  "row" - {
    ...
    "when answer unavailable, return empty" in {
      val userAnswers = UserAnswers("id")
      ValueNewLtaChargeSummary.row(userAnswers) shouldBe None
    }
  }

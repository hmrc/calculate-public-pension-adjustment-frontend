...
import views.html.TriageJourneyNotImpactedPIADecreaseView
...
class TriageJourneyNotImpactedPIADecreaseControllerSpec extends SpecBase {
  ...
  "TriageJourneyNotImpactedPIADecrease Controller" - {
    ...
    "must return OK and the correct view for a GET" in {
      ...
      running(application) {
        val request = FakeRequest(GET, routes.TriageJourneyNotImpactedPIADecreaseController.onPageLoad().url)

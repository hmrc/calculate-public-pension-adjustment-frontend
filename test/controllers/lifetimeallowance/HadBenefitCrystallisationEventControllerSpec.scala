...
import views.html.HadBenefitCrystallisationEventView

import scala.concurrent.Future

class HadBenefitCrystallisationEventControllerSpec extends SpecBase with MockitoSugar {
  ...
  "HadBenefitCrystallisationEvent Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = UserAnswers(userAnswersId).set(HadBenefitCrystallisationEventPage, true).success.value

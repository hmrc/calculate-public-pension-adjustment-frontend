...
import models.{Done, NewExcessLifetimeAllowancePaid, NormalMode, UserAnswers}
...
import views.html.lifetimeallowance.NewExcessLifetimeAllowancePaidView

import scala.concurrent.Future

class NewExcessLifetimeAllowancePaidControllerSpec extends SpecBase with MockitoSugar {
  ...
  "NewExcessLifetimeAllowancePaid Controller" - {
    ...
    "must return OK and the correct view for a GET" in {
      ...
      running(application) {
        ...
        val view = application.injector.instanceOf[NewExcessLifetimeAllowancePaidView]

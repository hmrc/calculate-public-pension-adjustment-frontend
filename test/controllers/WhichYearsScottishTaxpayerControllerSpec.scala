...
class WhichYearsScottishTaxpayerControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val whichYearsNormalRoute = routes.WhichYearsScottishTaxpayerController.onPageLoad(NormalMode).url
  lazy val whichYearsCheckRoute  = routes.WhichYearsScottishTaxpayerController.onPageLoad(CheckMode).url

...
import views.html.annualallowance.WhatYouWillNeedAAView

class WhatYouWillNeedAAControllerSpec extends SpecBase {

  "WhatYouWillNeedAA Controller" - {
    ...
    "must return OK and the correct view for a GET" in {
      ...
      running(application) {
        val request =
          FakeRequest(GET, controllers.annualallowance.routes.WhatYouWillNeedAAController.onPageLoad(Period._2018).url)

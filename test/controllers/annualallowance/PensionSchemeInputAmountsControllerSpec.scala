...
import forms.annualallowance.PensionSchemeInputAmountsFormProvider
import models.{NormalMode, PensionSchemeInputAmounts, Period, SchemeIndex, UserAnswers}
import org.mockito.ArgumentMatchers.any
import org.mockito.Mockito.when
import org.scalatestplus.mockito.MockitoSugar
import pages.annualallowance.PensionSchemeInputAmountsPage
...
import views.html.annualallowance.PensionSchemeInputAmountsView
...
class PensionSchemeInputAmountsControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val pensionSchemeInputAmountsRoute =
    controllers.annualallowance.routes.PensionSchemeInputAmountsController

...
import pages.annualallowance.{PensionSchemeDetailsPage, WhichSchemePage}
...
class WhichSchemeControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val whichSchemeRoute =
    controllers.annualallowance.routes.WhichSchemeController.onPageLoad(NormalMode, Period._2018, SchemeIndex(0)).url

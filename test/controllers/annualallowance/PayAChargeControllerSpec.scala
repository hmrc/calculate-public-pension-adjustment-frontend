...
import forms.annualallowance.PayAChargeFormProvider
import models.{NormalMode, Period, SchemeIndex, UserAnswers}
import org.mockito.ArgumentMatchers.any
import org.mockito.Mockito.when
import org.scalatestplus.mockito.MockitoSugar
import pages.annualallowance.PayAChargePage
import play.api.inject.bind
import play.api.mvc.Call
import play.api.test.FakeRequest
import play.api.test.Helpers._
import repositories.SessionRepository
import views.html.annualallowance.PayAChargeView
...
class PayAChargeControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val payAChargeRoute =
    controllers.annualallowance.routes.PayAChargeController.onPageLoad(NormalMode, Period._2018, SchemeIndex(0)).url
  ...
  "PayACharge Controller" - {
    ...
    "must redirect to the next page when valid data is submitted" in {
      ...
      running(application) {
        ...
        val userAnswers = emptyUserAnswers.set(PayAChargePage(Period._2018, SchemeIndex(0)), false)

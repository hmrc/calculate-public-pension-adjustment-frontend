    ...
    "must return relevant answers for income sub journey user answers" in {
      ...
      running(application) {
        ...
        val expectedSeq = Seq(
          ...
          HowMuchContributionPensionSchemeSummary.row(userAnswers, Period._2022)(messages(application)),

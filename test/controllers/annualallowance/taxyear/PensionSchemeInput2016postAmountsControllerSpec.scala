...
import models.{Done, NormalMode, PensionSchemeInput2016postAmounts, Period, SchemeIndex, UserAnswers}
...
class PensionSchemeInput2016postAmountsControllerSpec extends SpecBase with MockitoSugar {
  ...
  "PensionSchemeInput2016postAmounts Controller" - {
    ...
    "must return OK and the correct view for a GET" in {
      ...
      running(application) {
        val request = FakeRequest(GET, pensionSchemeInput2016postAmountsRoute)

        val view = application.injector.instanceOf[PensionSchemeInput2016postAmountsView]

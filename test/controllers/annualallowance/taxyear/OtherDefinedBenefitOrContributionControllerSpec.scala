...
class OtherDefinedBenefitOrContributionControllerSpec extends SpecBase with MockitoSugar {
  ...
  "OtherDefinedBenefitOrContribution Controller" - {
    ...
    "must return OK and the correct view for a GET" in {
      ...
      running(application) {
        val request = FakeRequest(GET, otherDefinedBenefitOrContributionRoute)
    ...
    "must redirect to the next page when valid data is submitted" in {
      ...
      running(application) {
        val request =
          FakeRequest(POST, otherDefinedBenefitOrContributionRoute)

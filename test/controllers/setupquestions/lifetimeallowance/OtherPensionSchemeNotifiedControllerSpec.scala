...
import forms.setupquestions.lifetimeallowance.OtherPensionSchemeNotifiedFormProvider
...
import views.html.setupquestions.lifetimeallowance.OtherPensionSchemeNotifiedView

import scala.concurrent.Future

class OtherPensionSchemeNotifiedControllerSpec extends SpecBase with MockitoSugar {
  ...
  "OtherPensionSchemeNotified Controller" - {
    ...
    "must return OK and the correct view for a GET" in {
      ...
      running(application) {
        ...
        val view = application.injector.instanceOf[OtherPensionSchemeNotifiedView]
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = UserAnswers(userAnswersId).set(OtherPensionSchemeNotifiedPage, true).success.value

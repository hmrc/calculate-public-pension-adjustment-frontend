...
import pages.annualAllowance.setupQuestions.FlexibleAccessStartDatePage
import play.api.inject.bind
import play.api.mvc.{AnyContentAsEmpty, AnyContentAsFormUrlEncoded, Call}
import play.api.test.FakeRequest
import play.api.test.Helpers._
import repositories.SessionRepository
import views.html.annualAllowance.setupQuestions.FlexibleAccessStartDateView
...
class FlexibleAccessStartDateControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val normalRoute = setupAARoutes.FlexibleAccessStartDateController.onPageLoad(NormalMode).url
  lazy val checkRoute  = setupAARoutes.FlexibleAccessStartDateController.onPageLoad(CheckMode).url

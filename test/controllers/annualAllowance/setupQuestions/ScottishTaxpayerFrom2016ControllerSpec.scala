...
import forms.annualAllowance.setupQuestions.ScottishTaxpayerFrom2016FormProvider
...
import views.html.annualAllowance.setupQuestions.ScottishTaxpayerFrom2016View
...
class ScottishTaxpayerFrom2016ControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val scottishTaxpayerNormalRoute = setupAARoutes.ScottishTaxpayerFrom2016Controller.onPageLoad(NormalMode).url
  lazy val scottishTaxpayerCheckRoute  = setupAARoutes.ScottishTaxpayerFrom2016Controller.onPageLoad(CheckMode).url
  ...
  "ScottishTaxpayerFrom2016 Controller" - {
    ...
    "redirect to WhichYearsScottishTaxpayer page when user answers true in Normal Mode" in {
      ...
      running(application) {
        ...
        status(result) mustEqual SEE_OTHER
        redirectLocation(result).value mustEqual setupAARoutes.WhichYearsScottishTaxpayerController.onPageLoad(NormalMode).url
      }
    }
    ...
    "redirect to WhichYearsScottishTaxpayer page when user answers true in Check Mode" in {
      ...
      running(application) {
        ...
        status(result) mustEqual SEE_OTHER
        redirectLocation(result).value mustEqual setupAARoutes.WhichYearsScottishTaxpayerController.onPageLoad(CheckMode).url
      }
    }
